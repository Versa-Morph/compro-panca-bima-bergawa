...
@section('content')
    ...
    <section class="page-title page-title-layout2 bg-overlay bg-overlay-2 bg-parallax">
        <div class="bg-img"><img src="{{ asset('assets/images/pbb-img/service/turnkey-project-management-4.jpg') }}" alt="background"></div>
        <div class="container">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-8">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="gallery-item">
                    <a class="popup-gallery-item" href="{{ asset('assets/images/pbb-img/service/turnkey-project-management-1.jpg') }}">
                      <img src="{{ asset('assets/images/pbb-img/service/turnkey-project-management-1.jpg') }}" alt="gallery img" style="max-height: 30vh !important; min-width: 100% !important;">
                    </a>
                  </div><!-- /.gallery-item -->
                </div><!-- /.col-sm-6 -->
                <!-- gallery item #2 -->
                <div class="col-sm-6">
                  <div class="gallery-item">
                    <a class="popup-gallery-item" href="{{ asset('assets/images/pbb-img/service/turnkey-project-management-2.jpg') }}">
                      <img src="{{ asset('assets/images/pbb-img/service/turnkey-project-management-2.jpg') }}" alt="gallery img" style="max-height: 30vh !important; min-width: 100% !important;">
                    </a>
                  </div><!-- /.gallery-item -->
                </div><!-- /.col-sm-6 -->
              </div><!-- /.row -->
              ...
              <div class="video-banner mb-70">
                <img src="{{ asset('assets/images/pbb-img/service/turnkey-project-management-3.jpg') }}" alt="banner">
