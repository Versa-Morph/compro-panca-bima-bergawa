          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="post-item">
                <div class="post__img">
                  <a href="{{ route('user.news.detail') }}">
                    <img src="{{ asset('assets/images/blog/grid/4.jpg') }}" alt="post image" loading="lazy">
                  </a>
                  <span class="post__date">Jan 20, 2020</span>
                </div><!-- /.post-img -->
                <div class="post__body">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="post-item">
                <div class="post__img">
                  <a href="{{ route('user.news.detail') }}">
                    <img src="{{ asset('assets/images/blog/grid/5.jpg') }}" alt="post image" loading="lazy">
                  </a>
                  <span class="post__date">Jan 20, 2020</span>
                </div><!-- /.post-img -->
                <div class="post__body">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
              <div class="post-item">
                <div class="post__img">
                  <a href="{{ route('user.news.detail') }}">
                    <img src="{{ asset('assets/images/blog/grid/6.jpg') }}" alt="post image" loading="lazy">
                  </a>
                  <span class="post__date">Jan 20, 2020</span>
                </div><!-- /.post-img -->
                <div class="post__body">
